...
<div class="description">
  ...
  <p>
    <br> This demo showcases how Personally Identifiable Information (PII) data can be protected from unauthorized access by leveraging a feature in Microsoft Fabric to automatically redact any such data (like date of birth, SSN, Account Number) which can be used to identify an individual, before saving it.
  </p>
</div>
