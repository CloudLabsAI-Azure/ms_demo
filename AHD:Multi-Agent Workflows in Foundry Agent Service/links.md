...
<div class="description">
  ...
  <p>
    <br> This demonstration showcases the execution and monitoring of multi-agent workflows using the Microsoft Foundry Agent Service. It provides a hands-on walkthrough of navigating Azure AI Foundry, reviewing and interacting with workflows such as the Shopping Assistant, and observing how multiple agents collaborate to fulfill user requests. The use case highlights real-time agent invocation, traceability through detailed execution logs, and performance monitoring via evaluation metrics, serving as a blueprint for building, analyzing, and optimizing multi-agent systems in enterprise environments.
  </p>
</div>
